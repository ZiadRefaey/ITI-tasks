...
Box.prototype.valueof = function (box) {
  if ((!box) instanceof Box) throw new Error("must be a box object");
  var books1 = this.countBooks();
  var books2 = box.countBooks();
...
var box2 = new Box(5, 5, 5, "any");
box.addBook(book1);
box.addBook(book2);
box.addBook(book3);
console.log(box.toString());
console.log(box.valueof(box2));
box.valueof(box2);
